...
- **Total Automated Tests:** **3,083 automated tests** (114 Vitest + 2,969 Pytest across 7 tiers), measured 2026-09-03 by `pnpm exec vitest run` and `pytest --collect-only`
