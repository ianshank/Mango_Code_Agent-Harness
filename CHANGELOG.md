...
- **NS-39:** traceability ratchet lowered; tests-only contract IDs cited in `contract_citations.py`; AC-GEA-8 baseline under `docs/reports/` with `test_code_graph_is_gated_on_a_recorded_baseline`. No CPG.
