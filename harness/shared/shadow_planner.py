...
def _policy_identity(workspace_dir: Path) -> tuple[str, str]:
    ...
    except Exception:  # noqa: BLE001 - identity is diagnostic metadata; failing to
...
def run_shadow_comparison(
    ...
    except Exception:  # noqa: BLE001 - this IS the containment boundary (INV-16):
...
def _run(
    ...
    try:
        ...
        except Exception:  # noqa: BLE001 - best-effort telemetry inside an error
