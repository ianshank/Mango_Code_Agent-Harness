...
CRITICAL_PATTERNS = {
    ...
    ".claude/agents/**": "subagent definitions; each one grants a tool allowlist",
...
CONTROL_SURFACE = {
    ...
    ".claude/agents/directory-doc-author.md": "a subagent definition, and its `tools:` line is a grant",
