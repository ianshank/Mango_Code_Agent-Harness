...
definition (C-GT-1, C-LGH-2, C-PLR-2, C-PLR-3, R-AC-5, R-CGT-1, R-CGT-4,
R-CGT-7, R-MMI-7, R-PLR-2, R-PLR-3, R-PLR-4, R-RPT-6, R-VP-2, R-VP-5).
R-GEA-5 is deliberately left uncited.
"""
