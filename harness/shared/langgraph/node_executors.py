"""LangGraph agent execution nodes wrapping orchestrator execution methods."""
...
from harness.shared.langgraph.node_reasons import _nonneg_int_count
...
@with_authority("verifier", may_write=False)
def peer_reviewer_node(state: MangoState) -> dict[str, Any]:
