...
``python harness/<stack>/scripts/pretooluse_guard.py`` is behaviorally identical to
``python harness/shared/pretooluse_guard.py`` (same CLI, same CWD-relative path
...
runpy.run_path(str(_SHARED / "pretooluse_guard.py"), run_name="__main__")
