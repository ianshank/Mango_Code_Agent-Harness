...
``python harness/<stack>/scripts/validate_adoption.py`` is behaviorally identical to
``python harness/shared/validate_adoption.py`` (same CLI, same CWD-relative path
...
runpy.run_path(str(_SHARED / "validate_adoption.py"), run_name="__main__")
