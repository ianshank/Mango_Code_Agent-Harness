...
``python harness/<stack>/scripts/check_projections.py`` is behaviorally identical to
``python harness/shared/check_projections.py`` (same CLI, same CWD-relative path
...
runpy.run_path(str(_SHARED / "check_projections.py"), run_name="__main__")
