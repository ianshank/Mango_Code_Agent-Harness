...
``python harness/<stack>/scripts/validate_agent_policy.py`` is behaviorally identical to
...
runpy.run_path(str(_SHARED / "validate_agent_policy.py"), run_name="__main__")
