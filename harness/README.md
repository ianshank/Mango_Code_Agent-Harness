...
- `docs/` — **`BENCHMARK_REPORT.md`**, `AGENT_GOVERNANCE.md`, `ROOT_OF_TRUST.md` and `PRE_PR_VERIFICATION_REFERENCE.md`. The C4 model lives at the repository's `docs/architecture/c4_architecture.md`. Reports are under `docs/reports/`: `2026-STANDARDS-AUDIT.md` (the current coding-standards audit and its remediation roadmap), `PEER-REVIEW-REMEDIATION.md`, `ROADMAP-PEER-REVIEW.md`, `ROADMAP-PEER-REVIEW-2026-09-05.md`, `PLAYLIST-ASTRA-CONTEXT-BUDGET-PLAN-2026-09-06.md`, `SDLC_HYGIENE_AND_GAP_ANALYSIS.md`, `SDLC_HYGIENE_REPORT.md` and `TEST-REPORT.md`; this list is checked against the directory by `test_documentation_claims.py`.
